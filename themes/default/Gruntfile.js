		...
		requirejs: {
			compile: {
				options: {
					...
					modules: [{"name":"pagetypes\/default"},{"name":"pagetypes\/newsarticle"},{"name":"pagetypes\/newsholder"},{"name":"pagetypes\/page"},{"name":"pagetypes\/userdefinedform"}] // add modules here. e.g. : {name: 'pagetypes/pagename'}
				}
			}
		},
