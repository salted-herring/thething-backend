...
INSERT INTO `Member` VALUES (1,'Member','2013-11-21 09:30:34','2014-06-12 16:34:55','Default Admin',NULL,NULL,NULL,NULL,12,'2014-06-19 10:35:57',NULL,NULL,NULL,NULL,NULL,NULL,'en_US',0,NULL,NULL,0,NULL,NULL),(2,'Member','2015-04-02 15:55:46','2015-04-20 14:21:45','Default Admin',NULL,'defaultadmin',NULL,NULL,2,'2015-04-20 15:08:00',NULL,NULL,NULL,NULL,NULL,NULL,'en_US',0,NULL,NULL,0,'b5adeee4033c09099ec7e40c6b025849d7c0515a','2015-04-23 14:21:45');
...
CREATE TABLE `SiteTree` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ClassName` enum('SiteTree','Page','NewsArticle','NewsHolder','ErrorPage','RedirectorPage','VirtualPage','UserDefinedForm','BlogEntry','BlogHolder','TechnologyPage','ProductsPage','ResultsPage','AboutPage','PanelPage','ContactPage') DEFAULT 'SiteTree',
  `Created` datetime DEFAULT NULL,
  `LastEdited` datetime DEFAULT NULL,
  `URLSegment` varchar(255) DEFAULT NULL,
  `Title` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2015-04-20 18:02:19
